...
namespace BSTU.FileCabinet.Domain.Models
{
    ...
    public partial class FileCabinetContext : DbContext
    {
        ...
        public virtual ObjectResult<GetStudentsOfGroup_Result> GetStudentsOfGroup(Nullable<int> groupId)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext
                .ExecuteFunction<GetStudentsOfGroup_Result>("GetStudentsOfGroup", groupIdParameter);
        }
        ...
        public virtual ObjectResult<GetSubjectsOfStudent_Result> GetSubjectsOfStudent(Nullable<int> studentId)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext
                .ExecuteFunction<GetSubjectsOfStudent_Result>("GetSubjectsOfStudent", studentIdParameter);
        }
    }
}
